...
\begin{tikzpicture}[overlay]
    \node[anchor=south west,inner sep=0] at (0.4\slidewidth,-0.2\slideheight) {\includegraphics[width=0.3\slidewidth]{ball.ps}};
\end{tikzpicture}
...
\begin{tikzpicture}[overlay]
    \node at (0.35\slidewidth,-0.49\slideheight) {\includegraphics[width=0.3\slidewidth]{ball.ps}};
\end{tikzpicture}

\begin{itemize}
  \item annotational inconsistencies\newline
\begin{tikzpicture}[overlay]
  \draw (4.4,-2.4)--(4.5,-2.3)--(4.6,-2.5);
\end{tikzpicture}
  
  \pause\item inconsistent format of data
  \begin{tikzpicture}[overlay]
  \draw (.75,-2.1)--(.65,-2)--(.55,-2.2);
\end{tikzpicture}
  \pause$\Rightarrow$ high programming overhead\newline
    \begin{tikzpicture}[overlay]
  \draw (4.35,-1.84)--(4.47,-1.74)--(4.6,-1.94);
\end{tikzpicture}

  \pause\item inconsistent / unbalanced reactions in databases\newline
      \begin{tikzpicture}[overlay]
  \draw (4.4,2.9)--(4.6,3.11)--(4.7,2.95);
\end{tikzpicture}
